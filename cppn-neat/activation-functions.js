...
export function setActivationFunctionsDefaultProbabilities( cppnjs, activationFunctionProbabilities ) {
  //makes these the only activation functions being generated by wave genotypes -- all equal probabilibty for now

  // if( ! activationFunctionProbabilities ) activationFunctionProbabilities = {};
