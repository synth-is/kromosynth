#!/usr/bin/env node
/**
 * Test streaming render with additive synthesis genome
 */
...
// Additive synthesis test genome (found by genome search)
...
async function testAdditiveRender() {
    console.log('='.repeat(80));
    console.log('ADDITIVE SYNTHESIS TEST');
    console.log('='.repeat(80));
    console.log();

    // Load genome
    console.log('📂 Loading additive genome...');
    ...
    // Render with STREAMING mode
    console.log('🎵 Rendering with STREAMING mode (additive synthesis)...');
    ...
    if (nans === 0 && infs === 0 && valid > 0) {
        console.log('✅ SUCCESS: Additive synthesis rendered valid audio!');
        console.log('='.repeat(80));
        process.exit(0);
    } else {
