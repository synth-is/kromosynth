#!/usr/bin/env node
/**
 * Test basic streaming render with chunked CPPN activation
 */
...
async function testStreamingRender() {
    console.log('='.repeat(80));
    console.log('STREAMING RENDER TEST');
    console.log('='.repeat(80));
    console.log();
    ...
    if (nans === 0 && infs === 0 && valid > 0) {
        console.log('✅ SUCCESS: Streaming render produced valid audio!');
        console.log('='.repeat(80));
        process.exit(0);
    } else {
